...
### 📋 STEP 1: リモートデスクトップを開く

1. Windowsの検索欄で「リモートデスクトップ接続」と検索
...
1. **リモートデスクトップ接続**の「オプションの表示」をクリック
2. **「ローカル リソース」**タブを選択
3. **「リモート オーディオ」**セクションの**「設定」**ボタンをクリック
4. 以下の2つを設定：
   - **リモート オーディオ再生**: 「**このコンピューターで再生する**」を選択
   - **リモート オーディオ録音**: 「**このコンピューターから録音する**」を選択
5. **「OK」**をクリック
6. **「全般」**タブを選択
7. **「ログオン設定」**セクションの**「コンピュータ」**にご自身のグローバルIPを設定
8. **「接続」**をクリックしてVMに接続
9. ご自身のユーザー名とパスワードを入力してVMにログイン
